...
#define ECHO_PIN_2      5
#define TRIGGER_PIN_3   7  // CHECK THESE PINS WORK
#define ECHO_PIN_3      7
...
void setup() {
  Serial.begin (9600);
  dht.begin();
// ***** Can I put hum, soundsp and soundcm calculations in setup instead, so only done once ***** //
}
...
void loop()
{
 ...
 // Measure duration for first sensor
  ...
  distance3 = (duration2 / 2) * soundcm;
  
  // Send results to Serial Monitor // ***** PROBS WON'T USE THIS *****
